<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Course_System.Admin.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="mainbody">
                ...
                <div class="mt-4 px-md-5 px-sm-4" align="center">
                    <h2 class="pt-2" style="letter-spacing:1px;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif"><b>Edit Student Details</b></h2>
                    ...
                    <asp:Button class="btn btn-success w-25 mt-5" ID="btnupdate" runat="server" Text="Update" Font-Bold="True" ForeColor="White" style="border-radius:5px" OnClick="btnupdate_Click" />
