<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.Master" AutoEventWireup="true" CodeBehind="Courses.aspx.cs" Inherits="Course_System.Student.Courses" %>
              ...
              <div class="px-md-4 px-sm-2">
                  ...
                  <div class="p-4">
                      ...
                      <asp:Repeater ID="Repeater1" runat="server">
                          <ItemTemplate>
                              <a href="Modules.aspx?mid=<%#Eval("Module_Id") %>" target="_blank">
